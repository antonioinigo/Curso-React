...
function ActivityList() {
  ...
  return (
    <>
        ...
        {activities.length === 0 ? <p className="text-center text-lg text-slate-500">No hay actividades</p> : 

          state.activities.map(activity=>(
            <div key={activity.id} className='px-5 py-10 bg-whitemt-5 flex justify-between'>
